...
func Mappingwriter(Match_result_list []dataframe.Grade, writepath string, Query, Database []reader.Spectrum, Adduct_isotope_list dataframe.Adduct_isotope) {
	...
	f_o.WriteString("ID" + "\t" + "Score" + "\t" + "FDR" + "\t" + "Reference_spectrum" + "\t" + "Match_Score" + "\t" + "Match_Cosine" + "\t" + "TSNR" + "\t" + "ESNR" + "\t" + "Query_precursor_retention_time" + "\t" + "Query_precursor_mass" + "\t" + "Reference_precursor_mass" + "\t" + "Diviation_mass" + "\t" + "Adduct" + "\t" + "Adduct_mass" + "\t" + "Query_peaks number" + "\t" + "Reference_peaks number" + "\r\n")
	for i := len(Match_result_list) - 1; i >= 0; i-- {
		...
		f_o.WriteString(Query[Match_result_list[i].Queryindex].Spectrl_number + "\t" + Score + "\t" + FDR + "\t" + Database[Match_result_list[i].Index].Spectrl_number + "\t" + Potproduct + "\t" + Cosine + "\t" + TSNR + "\t" + ESNR + "\t" + Rtime + "\t" + Query_precursor_mass + "\t" + Reference_precursor_mass + "\t" + Diviation_precursor_mass + "\t" + Adduct + "\t" + Adduct_mass + "\t" + Query_peaks_number + "\t" + Reference_peaks_number + "\r\n")
	}
}
